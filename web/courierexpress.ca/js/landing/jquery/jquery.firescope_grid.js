...
jQuery.fn.firescope_grid = function(options) {
	...
	var cfg = {
        ...
        msgStatusDispFromToTotal:  '<span class="white_text" style="font-weight: normal">Displaying {from} to {to} of {total}</span>',
        msgStatusDispFromTo:       '<span class="white_text" style="font-weight: normal">Displaying {from} to {to}</span>',
        msgStatusDispNone:         '<span class="white_text" style="font-weight: normal">No results</span>',		
		msgRows:                   '', // Rows
		msgRefresh:                ' <span class="white_text" style="font-weight: normal">Refresh</span>',
	...
	var m_page = $('<span class="nav-page white_text" style="font-weight: normal">Page&nbsp;&nbsp;<input type="text" class="nav-page-input" size="4" value="' + cfg.page + '" /></span>');
