...
var tLH="SCCC";
var tLI="SCCC";
var tLnC='http://seal.globessl.com/';
if(window.location.protocol.toLowerCase()=="https:")
{tLnC='https://seal.globessl.com/';}
var tLbC=tLnC+"images/";
var tLlC=tLnC+"";
var tLyC=tLnC+"logos/";
var tLMC=tLnC+'?';
var tLLC=tLMC;tLMC=tLMC;
var tLNC='';
var tLgC=120;
var tLeC=360;var tLhC=580;if (window.attachEvent){var tLhC=620;var tLeC=460;}
...
if (version>=5.5 && (window.createPopup) && (!(document.documentElement && typeof document.documentElement.style.maxHeight!="undefined"))){document.writeln('<style type="text/css">#TL{display:none;}</style>');}
else {createStyleRule("#TL", "display:none;");}
...
var cot_bgf0=(window.location.protocol.toLowerCase()=="https:")? "https://seal.globessl.com/images/bgf0.gif" : "http://seal.globessl.com/images/bgf0.gif";
...
newwindow=window.open(url,'name','WIDTH=360,HEIGHT=600,FRAMEBORDER=0,MARGINWIDTH=0,MARGINHEIGHT=0,SCROLLBARS=1,allowtransparency=true');
if(window.focus){
newwindow.focus()
}
return false;
...
function COT(Logo,code,autoMove){
if (document.getElementById('TL')){
document.getElementById('TL').style.display="none";
}
host=location.host;if(window.location.protocol.toLowerCase()=="https:"){
cot_tl_dummyMini='https://seal.globessl.com/images/bgf0.gif';
cot_tl_miniBaseURL='https://seal.globessl.com/?domain='+host+'&frame=y';
cot_tl_bigBaseURL='https://seal.globessl.com/?domain='+host+'';
}
else{
cot_tl_dummyMini='https://seal.globessl.com/images/bgf0.gif';
cot_tl_miniBaseURL='http://seal.globessl.com/?domain='+host+'&frame=y';
cot_tl_bigBaseURL='http://seal.globessl.com/?domain='+host+'';
}
document.write('<div id="cot_tl_pop">');
document.write('<IFRAME id="frame_pop" name="frame_pop" src="'+cot_tl_dummyMini+'" WIDTH=244 HEIGHT=194 FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=no allowtransparency=true></IFRAME>');document.write('</div>');
document.write('<div id="cot_tl_fixed">');
document.write('<a href="https://www.GlobeSSL.com" onClick="return cot_tl_bigPopup(\''+cot_tl_bigBaseURL+'\')"><img src='+Logo+' alt="SSL Certificate" border="0" onMouseOver="Ovr=setTimeout(\'cot_tl_toggleMiniPOPUP_show()\',1000);clearTimeout(Ovr2)" onMouseOut="Ovr2=setTimeout(\'cot_tl_toggleMiniPOPUP_hide()\',3000);clearTimeout(Ovr)"></a>');
document.write('</div>');
}
// cot end
