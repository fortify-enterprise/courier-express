<div id="shopping_items" class="rounded_div" style="margin-top: 12.1em; height: 43.2em">
...
<span style="color: #E6E4C9">({$packages_cart|@sizeof} {__ text='items for checkout'})</span><br />
