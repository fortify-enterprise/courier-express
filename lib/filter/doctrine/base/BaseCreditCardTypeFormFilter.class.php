...
/**
 * CreditCardType filter form base class.
 *
 * @package    cexp
 * @subpackage filter
 ...
 */
abstract class BaseCreditCardTypeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('credit_card_type_filters[%s]');
